...
def owner():
    # Your code to render the player card template or return data goes here
    return render_template('owner.html', players=players)

@app.route('/main')
def main():
    current_charecter_id = session.get('current_charecter_id')
    for character in character_pool.characters:
        if character.id == current_charecter_id:
            bid_charecter = character
    # Your code to render the player card template or return data goes here
    return render_template('main.html', players=players, bid_charecter=bid_charecter)
